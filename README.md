...
spawn(function()
local message = Instance.new("Message",workspace)
message.Text = "Fe Invisible Fling By Mikhail Statuyev#5496 Loaded (wait 11 seconds to load)"
wait(11)
message:Destroy()
end)
...
memedog.Text = "Mikhail Statuyev#5496 for GUI"
...
die.Text = "Mikhail Statuyev#5496 for scripts"
...
axy.Text = "Mikhail Statuyev#5496 for UI Tween"
